...
// Show Groq settings. User can change API key and chat/image/STT/TTS models.
type ShowLLMGroqSettings struct {
}

func (st *ShowLLMGroqSettings) run(caller *ToolCaller, ui *UI) error {
	source_llm, err := NewLLMGroq("")
	if err != nil {
		return err
	}
	...
	ui.AddText(0, y, 1, 1, "Groq API endpoint")
