...
func (layTile *UiLayoutTile) SetForce(coord OsV4, priorUp bool, text string, cd color.RGBA) {
	layTile.force = true
	layTile.coord = coord
...
func (layTile *UiLayoutTile) Set(touchPos OsV2, coord OsV4, priorUp bool, text string, cd color.RGBA) {
