...
type Xai_completionV_props struct {
...
func (layout *Layout) AddXai_completionV_props(x, y, w, h int, props *Xai_completionV_props) *Xai_completionV_props {
	layout._createDiv(x, y, w, h, "Xai_completionV_props", props.Build, nil, nil)
	return props
}

func (st *Xai_completionV_props) Build(layout *Layout) {
